...
//        System.out.println(username+"  "+password);
        boolean res = consumerService.veritypasswd(username, password);                 //调用service层证实用户名密码
...
//    更新用户头像
    ...
    public class MyPicConfig implements WebMvcConfigurer {
        ...
        public void addResourceHandlers(ResourceHandlerRegistry registry) {
            registry.addResourceHandler("/avatorImages/**").addResourceLocations("file:D:/music_project/music-website/music-server/avatorImages/");
        }
    }
